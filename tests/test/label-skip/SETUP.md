...
func writeMinimalLeaf(t *testing.T, root, leafRel string) {
	...
	setup.WriteString("import \"testing\"\n\nfunc Setup(t *testing.T, d *session.Doctest, req *Request) error { t.Helper(); return nil }\n")
...
func writeMalformedAssertTree(t *testing.T) string {
	...
	content := "---\nlabel: [broken\n---\n\n## Expected\n\n" + goFence() + "func Assert(t *testing.T, d *session.Doctest, req *Request, resp *Response, err error) {}\n" + endFence()
