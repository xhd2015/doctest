...
- Second run is `0 Cached` after L1 intermediate SETUP.md change (leaf SETUP untouched).
...
func Assert(t *testing.T, req *Request, resp *Response, err error) {
    ...
    if !strings.Contains(req.MRSecond.Stdout, ", 0 Cached") {
        t.Fatalf("second run was cached after L1 SETUP.md edit; expected ', 0 Cached':\n%s", req.MRSecond.Stdout)
    }
}
```
