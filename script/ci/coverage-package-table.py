...
Skips script/, cmd/, and */legacy_* paths under github.com/xhd2015/doctest/.
...
def main() -> int:
    ...
    for line in path.read_text().splitlines():
        ...
        file = key.rsplit(":", 1)[0]
        if "github.com/xhd2015/doctest/" not in file:
            continue
        rel = file.split("github.com/xhd2015/doctest/", 1)[1]
