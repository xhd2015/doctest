...
func TestRunErrorCases(t *testing.T) {
	tests := []struct {
		...
		{name: "skill missing action", args: []string{"skill", "doc-spec"}, wantErr: "skill requires doc-spec, code-spec, tdd, tdd-lite, reproduce, review, output-assert, implementer, or designer plus show or install"},
